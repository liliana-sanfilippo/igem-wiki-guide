...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Scientfic illustration SDU Denmark 2023 (\url{https://2023.igem.wiki/sdu-denmark/) in the team colors.}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.45\linewidth}
        ...
        \caption{Illustration by Insa ENS Lyon 1 in 2023: \url{https://2023.igem.wiki/insaenslyon1/human-practices}.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\linewidth}
        \includegraphics[width=\linewidth]{chapters/images/epfl_24}
        \caption{Illustration by EPFL in 2024: \url{https://2024.igem.wiki/epfl/}.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\linewidth}
        \includegraphics[width=\linewidth]{chapters/images/freiburg_24}
        \caption{Illustration by Freiburg 2024: \url{https://2024.igem.wiki/freiburg/description}.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\linewidth}
        \includegraphics[width=\linewidth]{chapters/images/basis_china_25}
        \caption{Illustration by Basis China 2025: \url{https://2025.igem.wiki/basis-china/description}.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\linewidth}
        \includegraphics[width=\linewidth]{chapters/images/wageningen_22}
        \caption{Illustration by Wageningen 2022: \url{https://2022.igem.wiki/wageningen-ur/results}.}
    \end{subfigure}
