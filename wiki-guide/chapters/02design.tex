...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{chapters/images/hp_lyon_23}
    \caption{Illustration by Insa ENS Lyon 1 in 2023: \url{https://2023.igem.wiki/insaenslyon1/human-practices}.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{chapters/images/epfl_24}
    \caption{Illustration by EPFL in 2024: \url{https://2024.igem.wiki/epfl/}.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{chapters/images/freiburg_24}
