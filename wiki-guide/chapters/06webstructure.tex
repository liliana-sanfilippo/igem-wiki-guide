...
\section{Standard URL Pages}\label{sec:standard-url-pages} \index{Standard URL Pages}
...
\section{Additional Pages and Considerations}\label{sec:additional-pages-and-considerations}\index{Pages}
...
Consider adding these common pages:
...
\begin{itemize}
    ...
    \item \textbf{Lab Books / Notebook:} Document your experiments and lab work.
    ...
    \item \textbf{Materials and Methods / Experiments:} Naturally, you need to provide detailed information about the
    techniques, equipment, and protocols used in your project for both judges and future teams.
    ...
    \item \textbf{Parts:} Even if you are not going for a part prize, list the biological parts you designed or used in
    your project, following iGEM’s standards
    for documenting parts.
    \item Judging / Awards
...
Some teams like to spread out their documentation over non-standard pages.
Feel free to do this but make sure to link everything on the standard pages!

Further pages I encountered on wikis are:
\begin{itemize}
    \item Outlook / Future Directions / Application
    \item Proof of Concept
    \item Outreach
    \item Implementation
    \item Plasmid Design
    \item Design
    \item Brand / Development of logo design etc.
    \item Collaboration
    \item Milestones / Highlights
    \item Gallery
    \item Special Thanks
    \item Pages for specific side projects such as a video tutorial series,  Social Research / Survey, etc.
    \item Glossary
\end{itemize}

\section{Structuring for Easy Navigation}\label{sec:structuring-for-easy-navigation}
...
\section{Navigation Bar}\label{sec:enhancing-the-navigation-bar} \index{Navigation Bar}
...
\begin{itemize}
    ...
    For example, instead of using ``Proj.
    Des.'', use ``Project Description.''
...
\subsection{Navbar examples}\label{subsec:navbar-examples}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_marburg_24}
    \caption{Navbar by \team{marburg24}.}\label{fig:figure11}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_vilnius_25}
    \caption{Navbar by \team{vilnius25}.}\label{fig:figure10}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_kazakhstan_25}
    \caption{Navbar by \team{kazakhstan25}.}\label{fig:figure9}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_ucas_25}
    \caption{Navbar by \team{ucas25}.}\label{fig:figure8}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_groningen_25}
    \caption{Navbar by \team{groningen25}.}\label{fig:figure7}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_mcgill_23}
    \caption{Navbar by \team{mcgill23}.}\label{fig:figure6}
\end{figure}


% TODO bad example not sticky https://2023.igem.wiki/sdu-denmark/results


\section{Footer}\label{sec:footer}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Simply listing an email address can expose it to spambots.
        To mitigate this, consider using a contact form or disguise the email (e.g., using ``team name [at] domain [dot]
        com'').
    \end{itemize}
...
\subsection{Footer examples}\label{subsec:footer-examples}
\begin{itemize}
    \item \url{https://2025.igem.wiki/szu-china/design}
\end{itemize}
% todo footer_basis_25

\section{Header}\label{sec:header} \index{Header}
% TODO \url{https://2025.igem.wiki/bit-china/team}
% https://2025.igem.wiki/hust-china/design/
% https://2025.igem.wiki/ucas-china/engineering
% https://2025.igem.wiki/thessaloniki/software
% https://2025.igem.wiki/cjuh-jlu-china/software
% https://2025.igem.wiki/bit-china/team
...
\section{Additional Elements}\label{sec:additional-elements}
...
\subsection{Sidebar Navigation}\label{subsec:sidebar-navigation}
...
% \url{https://2025.igem.wiki/boston-boslab/description}
% https://2025.igem.wiki/ucas-china/engineering
\begin{figure}[H]
    \centering
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[height=10cm]{chapters/images/sb_vilnius_25}
        \caption{By \team{vilnius25}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[height=10cm]{chapters/images/sb_bnuzh_25}
        \caption{By \team{bnuzh25}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[height=10cm]{chapters/images/sb_bielefeld_25}
        \caption{By  \team{bielefeld25}}
    \end{subfigure}
    \caption{Sidebar designs by different teams.}\label{fig:figure5}
\end{figure}

\begin{figure}[H]
    \centering
    \begin{subfigure}[t]{\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/sb_hopkins_25}
        \caption{Top bar by Hopkins 2025: \url{https://2025.igem.wiki/hopkins/human-practices}}
    \end{subfigure}
    %\hfill
    %\begin{subfigure}[t]{0.7\linewidth}
    %    \includegraphics[width=0.2\textwidth]{chapters/images/mitochondria-black-lines}
    %\end{subfigure}
    \caption{Sidebar variation}\label{fig:figure4}
\end{figure}


\subsection{Cards}\label{subsec:cards} Consider adding cards at specific positions, such as the end of each page, to engage users and encourage them to explore related content.
These can highlight important links or additional resources.
% TODO Card row https://2025.igem.wiki/bielefeld-cebitec/human-practices
% https://2025.igem.wiki/utokyo/
\subsection{"Back to Top" Button}\label{subsec:"back-to-top"-button}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.2\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/btt_nmu_23}
        \caption{By \team{nmu23}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.2\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/btt_bielefeld_25}
        \caption{By \team{bielefeld25}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.2\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/btt_sdu_24}
        \caption{By \team{sdu24}}
    \end{subfigure}
    \hfill\label{fig:figure3}
\end{figure}
%
% https://2025.igem.wiki/aachen/gsmm#growth0

\subsection{Scrolling Progress Bar}\label{subsec:scrolling-progress-bar}
...
% https://2025.igem.wiki/ashesighana/description
% TODO Buttons: pb_aachen_25 & pb_munich_25
% todo https://2025.igem.wiki/cuhk-shenzhen/description
\begin{figure}[H]
    \centering
    \begin{subfigure}[t]{\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/pb_leiden_24}
        \caption{By \team{leiden24}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/pb_bielefeld_25}
        \caption{By \team{bielefeld25}}
    \end{subfigure}
    \hfill
    \caption{Progress bar designs by different teams.}\label{fig:figure2}
\end{figure}
...
\begin{figure}[H]
    ...
    \hfill
    \begin{subfigure}[t]{0.2\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/pb_aachen_25}
        \caption{By \team{aachen25}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.2\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/pb_munich_25}
        \caption{By \team{munich25}}
    \end{subfigure}
    \hfill
    \caption{Progress Bars and Back To Top Buttons combined.}\label{fig:figure}
\end{figure}

\subsection{Search Functionality}\label{subsec:search-functionality}
Incorporating a search bar allows users to quickly find specific content or sections within the wiki, enhancing usability.
\subsection{Suggested Reading}\label{subsec:suggested-reading}
