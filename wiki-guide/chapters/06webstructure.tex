...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[height=\textwidth]{chapters/images/sb_vilnius_25}
        \caption{By \team{vilnius25}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[height=\textwidth]{chapters/images/sb_bnuzh_25}
        \caption{By \team{bnuzh25}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[height=\textwidth]{chapters/images/sb_bielefeld_25}
