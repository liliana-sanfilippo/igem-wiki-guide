...
\begin{itemize}
    ...
    \begin{mybox}
        \begin{lstlisting}[language=TypeScript,label={lst:navlist}]
{
...
\subsection{Navbar examples}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_marburg_24}
    \caption{Navbar by Marburg 2024: \url{https://2024.igem.wiki/marburg}.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_vilnius_25}
    \caption{Navbar by Vilnius Lithuania 2025: \url{https://2025.igem.wiki/vilnius-lithuania/}.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_kazakhstan_25}
    \caption{Navbar by NU Kazakhstan 2025: \url{https://2025.igem.wiki/nu-kazakhstan/}.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_ucas_25}
    \caption{Navbar by UCAS China 2025: \url{https://2025.igem.wiki/ucas-china/}.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_groningen_25}
    \caption{Navbar by Groningen 2025: \url{https://2025.igem.wiki/groningen/}.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/images/nav_mcgill_23}
    \caption{Navbar by McGill 2023: \url{https://2023.igem.wiki/mcgill/}.}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/sb_vilnius_25}
        \caption{By Vilnius Lithuania 2025: \url{https://2025.igem.wiki/vilnius-lithuania/engineering/}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/sb_bnuzh_25}
        \caption{By BNUZH China 2025: \url{https://2025.igem.wiki/bnuzh-china/engineering}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/sb_bielefeld_25}
        \caption{By Bielefeld CeBiTec 2025: \url{https://2025.igem.wiki/bielefeld-cebitec/description}}
    \end{subfigure}
    \caption{Sidebar designs by different teams.}
\end{figure}
...
\begin{figure}[H]
    ...
    %\end{subfigure}
    \caption{Sidebar variation}
\end{figure}


\subsection{Cards} Consider adding cards at specific positions, such as the end of each page, to engage users and encourage them to explore related content.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.2\linewidth}
        ...
        \caption{By NMU China 2023: \url{https://2023.igem.wiki/nmu-china/description}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/btt_bielefeld_25}
        \caption{By Bielefeld CeBiTec 2025: \url{https://2025.igem.wiki/bielefeld-cebitec/}}
    \end{subfigure}
    \hfill
\end{figure}
% https://2025.igem.wiki/aachen/gsmm#growth0

\subsection{Scrolling Progress Bar}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{\linewidth}
        ...
        \caption{By Leiden 2024: \url{https://2024.igem.wiki/Leiden/human-practices}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{\linewidth}
        ...
        \caption{By Bielefeld CeBiTec 2025: \url{https://2025.igem.wiki/bielefeld-cebitec/}}
    \end{subfigure}
    \caption{Progress bar designs by different teams.}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{\linewidth}
        ...
        \caption{By Aachen 2025: \url{https://2025.igem.wiki/aachen}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{\linewidth}
        \includegraphics[width=\textwidth]{chapters/images/pb_munich_25}
        \caption{By \gls{munich25}}
    \end{subfigure}
    \caption{Progress Bars and Back To Top Buttons combined.}
\end{figure}
