    ...
    Will everyone get a section to work on? \\
    ...
    % TODO use my templete
    % Hinweis auf alte React version, .gitlab-ci.yml behalten und code einfach runter laden + Screenshot von
    % Templateauswahl evtl. oben mit rein nehmen
    % Screenshots wie man den code runter lädt von github als zip oder so
