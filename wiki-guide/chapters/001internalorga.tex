...
Please remember to be kind to your teammates and that this is not about control or who is right, but about being
thorough.
...
\begin{itemize}
    ...
    \item Email
    \item Additional info / notes (e.g.\ ``only gives in kind sponsoring'', ``prefers high social media activity'')
...
\begin{itemize}
    ...
    \item Did they consent to publication of interviews / transcripts or do they want to read ot first, \ldots
\end{itemize}
