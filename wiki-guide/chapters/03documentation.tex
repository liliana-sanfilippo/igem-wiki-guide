...
\subsection{Team Meetings} \label{sec:team-meetings} \index{Documentation!Meetings}
...
\end{itemize}
\subsection{Lab} \label{sec:lab} \index{Documentation!Lab}
...
\subsection{Integrated Human Practices} \label{sec:ihp} \index{Documentation!IHP} \index{Integrated Human Practices}
...
\begin{itemize}
    ...
    \end{itemize}
\end{itemize}
\subsection{MeetUps} \label{sec:meetups} \index{Documentation!MeetUps}
...
See also: \nameref{sec:internal-freeze}
\subsection{Milestone approach}
...
\begin{itemize}
    \item All existing (and proof read) texts (and graphics where applicable) from the last iteration are on the wiki (
    \textit{HTML / Template})
    \item Texts including sources exist for all past events and interviews (\textit{Word (texts) / BibTeX (sources)})
    \item All existing graphics and extra data have been uploaded to the upload tool (\textit{ulpoad})
