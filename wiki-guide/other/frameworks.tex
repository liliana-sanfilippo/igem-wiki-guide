...
\begin{center}
    \includegraphics[width=0.5\linewidth]{chapters/images/timelineBielefeld}
\end{center}
\begin{center}
    \includegraphics[width=0.5\linewidth]{chapters/images/timelineBielefeldOpen}
\end{center}
...
See at \url{https://2025.igem.wiki/dtu-denmark/human-practices}
\begin{center}
    \includegraphics[width=0.5\linewidth]{chapters/images/timelineDTU}
\end{center}
\begin{center}
    \includegraphics[width=0.5\linewidth]{chapters/images/timelineDTUOpen}
\end{center}