...

{
    ...
    \begin{minipage}[t]{0.7\linewidth}
        \begin{tabular}{p{\textwidth}}
            ...
            \cvevent{Reference generator component}{in progress}{package -- component}{TypeSxcript and React component using bibtex and nam parser to automatically parse references for wiki pages or scientifc blogging.}]{https://github.com/liliana-sanfilippo/react-bibtex-source-generator}\\
            \cvevent{React Library}{in planning}{package -- component}{Library of TypeScript and Ract components aimed at iGEM wikis.}{https://github.com/liliana-sanfilippo/igem-react-lib}
