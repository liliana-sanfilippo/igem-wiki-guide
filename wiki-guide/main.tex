...
\newglossary[tlg]{team}{tls}{tlo}{Team}
\makeglossaries
\loadglsentries{team_gloss}
...
% TODO Science communication - Bigen dazu dass das für später wichtig ist weil man das im Job können muss um
...
seasonal project documentation for the competition and how to document for future teams from your university.  \\ \newline
...
\part{Wiki development}\label{part:wiki-development}
...
%\input{chapters/19bestwiki}
Upload pending. % TODO
\newpage

\part{After the Jamboree}\label{part:after-the-jamboree}
...
\chapter{Component Examples}\label{ch:component-examples}
\input{other/components}

\chapter{Notable Design Examples}\label{ch:notable-design-examples}
\input{other/design}
\newpage
\chapter{Sources}\label{ch:sources}
\printglossary[type=team]
\newpage
\section{Associated software} \label{sec:associated-software}
\input{other/associated-software}
\newpage
\section{Attributions} \label{sec:attributions}
