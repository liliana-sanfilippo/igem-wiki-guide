...
\usepackage{sty/definitions}
\usepackage{sty/commands}
\usepackage{xcolor}
\definecolor{pgcolor}{HTML}{F6F1EA}

\begin{document}
    \pagecolor[HTML]{F6F1EA}
\frontmatter
...
\newpage
%
\chapter{The Wiki Thaw} \label{sec:thaw}
%\stand{June 2025}
%\subfile{sections/thaw}
\newpage
%
\chapter{HTML Cheat Sheet} \label{sec:htmlcheatsheet}
%\stand{June 2025}
%\subfile{sections/htmlcheatsheet}
\newpage
%
\chapter{Code Snippets and React Components} \label{sec:appendix}
%\stand{June 2025}
