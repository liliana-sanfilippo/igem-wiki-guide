...
This guide also serves as documentation to the associated template wiki, which teams are free to use as a starting point. It can be found at \url{https://github.com/liliana-sanfilippo/igem-wiki-guide}.  \\ \newline
